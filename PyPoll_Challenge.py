...
#The data requested by the Colorado Board of Elections
...
with open(file_to_load) as election_data:
    ...
    # For each row in the CSV file. (Starting in the second row).
    for row in reader:
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        # write the f-string to text file
    ...
    #note we have iterated over al counties
